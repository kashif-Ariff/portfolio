  ...
  <div class="contactUs">
    ...
    <div class="container">
      ...
      <div class="contactUs__head">
        ...
        >
          <div
              class="swiper-slide ContactUs__slide"
              role="presentation"
      ...
      <b-tabs v-model="tabIndex" nav-wrapper-class="d-none">
        <b-tab v-for="(item,index) in tabsContent" :key="index" :id="`supportCenter_${index}`" :button-id="`tab_supportCenter_${index}`">
          <div class="upperContact">
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="row mapDetail align-items-center">
                  ...
                  <div class="col-7">
                    <span class="detail">Kuwait City, 25501 Mansouriya</span>
                  </div>
                </div>
                <div class="row mapDetail align-items-center">
                  <div class="col-5 d-flex align-items-center">
                  ...
                  <div class="col-7">
                    <span class="detail">info@nationalfund.gov.kw</span>
                  </div>
                </div>
                <div class="row mapDetail align-items-center">
                  <div class="col-5 d-flex align-items-center">
                ...
                <div class="row mapDetail align-items-center">
                  ...
                  <div class="col-7">
                    <span class="detail">8:30 am - 1:00 pm</span>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="map custom-border-radius">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14143117.941545919!2d60.32337114882688!3d30.068124090484673!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38db52d2f8fd751f%3A0x46b7a1f7e614925c!2sPakistan!5e0!3m2!1sen!2s!4v1628862714297!5m2!1sen!2s" style="border:0;" allowfullscreen=""></iframe>
                </div>
              </div>
            </div>
          </div>
          <div class="formDetail">
            <div class="title d-flex align-items-center">
              <span class="icon">
                <base-svg-icon
                          icon-id="agent"
                          icon-viewbox="0 0 29.531 25.958"
                        ></base-svg-icon>
              </span>
              <span class="label">We’re more than happy to help. Give us a call or just drop a message.</span>
            </div>
            <div class="row">
              <div class="col-md-6">
            ...
            <div class="button-row justify-content-end mt-30">
              <button class="btn btn-primary">Send <i class="fa fa-angle-right ml-10"></i></button>
            </div>
          </div>
        </b-tab>
      </b-tabs>
