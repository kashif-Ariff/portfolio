  ...
  methods: {
    setUpCarousel: function () {
      ...
      if (this.slider) {
        ...
        console.log(length);
        if (length == 0) {
          length = this.slider.querySelectorAll(".swiper-slide").length;
          // document
    ...
    mainBanner: function () {
      this.swiper.on("slideChange", (e) => {
        ...
        setTimeout(() => {
          ...
          var currentSlide = this.slider.querySelector(".swiper-slide-active");
          var mp4 = currentSlide.querySelector(".video-mp4");
          var image = currentSlide.querySelector(".banner__slide--image");
          ...
          if (currentSlide.classList.contains("has-video")) {
            if (mp4) {
              ...
              youtube.querySelector("iframe").setAttribute("src", vs);
              youtube.querySelector("iframe").setAttribute("tabindex", -1);
              image.classList.add("invisible");
              this.stopMp4();
            } else {
              this.stopYoutube();
