<template>
	<div class="main-common service offices">
		<div class="container">
			<div class="slider-header">
				<div class="row">
					<div class="col-12 col-lg-9">
						...
						<p>
							Lorem Ipsum is simply dummy is the text of the
							printing .
						</p>
					</div>
...
<script>
import BaseDetailCard from '../../../common/components/base/BaseDetailCard.vue';
export default {
